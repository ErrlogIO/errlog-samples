...
This project will show you how to use ErrLog.IO in a .Net Framework console (C#) project to catch and log exception errors.

This project uses the `AppDomain.CurrentDomain.UnhandledException` property to catch the unhandled exception.
...
...
```
This will catch any exceptions that cause the web applicaiton to stop. If there's an unhandled exception then it will be logged to your ErrLog.IO dashboard.
