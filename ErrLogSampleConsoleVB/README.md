...
This project will show you how to use ErrLog.IO in a .Net Framework console (VB) project to catch and log exception errors.
...
Add your `apikey` to the Main method of Program.vb file.
